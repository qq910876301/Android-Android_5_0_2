...
#define FSL_PREFERENCE_KEEPRATE "display_keeprate"
#define FSL_PREFERENCE_MODE "display_mode"
#define FSL_PREFERENCE_COLORDEPTH "display_colordepth"
...
enum DISPLAY_OPERATE_CODE {
    ...
    OPERATE_CODE_CHANGE_HDMIRESOLUTION = 0x40,
    OPERATE_CODE_CHANGE_ROTANGLE = 0x80,
    OPERATE_CODE_CHANGE_NAVBARVISIBLE = 0x100,
};
...
struct configParam {
    configParam() : displayId(-1), operateCode(OPERATE_CODE_INVALIDE),
      rotation(0), xOverScan(0), yOverScan(0), mirror(0), colorDepth(0), keepRate(SETTING_MODE_FULL_SCREEN), resolution(10806011), mode()
    {}
