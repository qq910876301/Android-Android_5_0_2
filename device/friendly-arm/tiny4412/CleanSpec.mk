...
ifeq ($(TARGET_PRODUCT),full_tiny4412)
# For example:
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/obj/STATIC_LIBRARIES/libaudioutils_intermediates)
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/obj/FAKE/prebuilt.*)
endif
