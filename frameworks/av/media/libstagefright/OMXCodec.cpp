...
#ifdef USE_SAMSUNG_COLORFORMAT
const static int OMX_SEC_COLOR_FormatNV12TPhysicalAddress = 0x7F000001;
const static int OMX_SEC_COLOR_FormatNV12LPhysicalAddress = 0x7F000002;
const static int OMX_SEC_COLOR_FormatNV12LVirtualAddress = 0x7F000003;
const static int OMX_SEC_COLOR_FormatNV12Tiled = 0x7FC00002;
#ifdef S3D_SUPPORT
const static int OMX_SEC_COLOR_FormatNV12Tiled_SBS_LR = 0x7FC00003;
const static int OMX_SEC_COLOR_FormatNV12Tiled_SBS_RL = 0x7FC00004;
const static int OMX_SEC_COLOR_FormatNV12Tiled_TB_LR = 0x7FC00005;
const static int OMX_SEC_COLOR_FormatNV12Tiled_TB_RL = 0x7FC00006;
const static int OMX_SEC_COLOR_FormatYUV420SemiPlanar_SBS_LR = 0x7FC00007;
const static int OMX_SEC_COLOR_FormatYUV420SemiPlanar_SBS_RL = 0x7FC00008;
const static int OMX_SEC_COLOR_FormatYUV420SemiPlanar_TB_LR = 0x7FC00009;
const static int OMX_SEC_COLOR_FormatYUV420SemiPlanar_TB_RL = 0x7FC0000A;
const static int OMX_SEC_COLOR_FormatYUV420Planar_SBS_LR = 0x7FC0000B;
const static int OMX_SEC_COLOR_FormatYUV420Planar_SBS_RL = 0x7FC0000C;
const static int OMX_SEC_COLOR_FormatYUV420Planar_TB_LR = 0x7FC0000D;
const static int OMX_SEC_COLOR_FormatYUV420Planar_TB_RL = 0x7FC0000E;
#endif
    ...
    switch (colorFormat) {
        ...
        */
        ...
        case OMX_SEC_COLOR_FormatNV12LVirtualAddress:
            return (ALIGN((ALIGN(width, 16) * ALIGN(height, 16)), 2048) +
                    ALIGN((ALIGN(width, 16) * ALIGN(height >> 1, 8)), 2048));

        case OMX_SEC_COLOR_FormatNV12Tiled:
            return (ALIGN_TO_8KB(ALIGN_TO_128B(width) * ALIGN_TO_32B(height)) +   // Y-size
                    ALIGN_TO_8KB(ALIGN_TO_128B(width) * ALIGN_TO_32B(height/2))); //UV-size
#endif
...
#ifdef USE_SAMSUNG_COLORFORMAT
    } else if (type == OMX_SEC_COLOR_FormatNV12TPhysicalAddress) {
        return "OMX_SEC_COLOR_FormatNV12TPhysicalAddress";
    } else if (type == OMX_SEC_COLOR_FormatNV12LPhysicalAddress) {
        return "OMX_SEC_COLOR_FormatNV12LPhysicalAddress";
    } else if (type == OMX_SEC_COLOR_FormatNV12LVirtualAddress) {
